...
const notifyTournamentStateChanged = () => {
  if (typeof window === 'undefined' || !window.localStorage) {
    return
  }

  try {
    window.localStorage.setItem(TOURNAMENT_SYNC_KEY, String(Date.now()))
  } catch {
...
export const submitAssistantPlayoffPlayerScore = async (payload) =>
  submitPlayoffPlayerScore({
    ...payload,
    source: 'assistant',
  })
